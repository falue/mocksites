...
$.extend($.validator, {
	...
	messages: {
		required: "Diese Angaben sind erforderlich.",
		remote: "Bitte überprüfen Sie Ihre Eingaben.",
...
//		numberDE: "Bitte geben Sie eine Nummer ein.",
		...
		accept: "Bitte geben Sie eine gültige Dateierweiterung ein.",
		...
		rangeLength: $.validator.format("Bitte geben Sie zwischen {0} und {1} Zeichen ein."),
		rangeValue: $.validator.format("Bitte geben Sie einen Wert zwischen {0} und {1} ein."),
		range: $.validator.format("Bitte geben Sie einen Wert zwischen {0} und {1} ein."),
		maxValue: $.validator.format("Bitte geben Sie einen Wert kleiner oder gleich {0} ein."),
		max: $.validator.format("Bitte geben Sie einen Wert kleiner oder gleich {0} ein."),
		minValue: $.validator.format("Bitte geben Sie einen Wert grösser oder gleich {0} ein."),
		min: $.validator.format("Bitte geben Sie einen Wert grÃ¶oder gleich {0} ein.")
	},
