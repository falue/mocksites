...
<nav>
  ...
  <select class="bday_y">
    ...
    <br>
      &nbsp;E-Mail-Adresse:<br>
  <input type="text" name="email" placeholder="name@e-mail.de" autocomplete="off"><br>
      &nbsp;Passwort:<br>
...
<video autoplay=\"\" muted=\"\" loop=\"\" poster=\"tools/stock/zoosk-hero-min.jpg\" preload=\"auto\" id=\"zoosk-video\" class=\"zoosk-video\">
  <source src=\"tools/stock/zoosk-commercial.mp4\" type=\"video/mp4\">
  <source src=\"tools/stock/zoosk-commercial.ogv\" type=\"video/ogg\">
  <source src=\"tools/stock/zoosk-commercial.webm\" type=\"video/webm\">
</video>
</div>";

} else {
echo "<div class=\"video_wrapper\" style=\"background-image:url(tools/stock/zoosk-hero-min.jpg);\">
&nbsp;</div>";
}
