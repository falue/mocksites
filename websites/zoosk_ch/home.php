...
<head>
  ...
  ?>
<title>Zoosk.com<? echo $browsertitle; ?></title>
...
<body>
	...
	<div class=\"window_body\"><h1>Willkommen auf Zoosk!</h1><div class=\"window_body_box\">Die Blauen K&auml;stchen zeigen dir, wie du mit Singles &uuml;ber das Karussell Kontakt aufnimmst.<center><a href=\"home.php\"><div style=\"display:inline-box; border-radius:4px; height:30px; border:1px solid rgba(255,255,255,0.2);padding-top: 8px; width:200px;\">Start</div></a></center></div>
	</div>
	</div>";
	  }
...
?>&nbsp;
	...
	<span class="legal_red">* K&uuml;rzlich aktualisiert</span>
	  <hr>
		...
		&copy; 2007-2016 Zoosk, Inc. Alle Rechte vorbehalten.
		</span>
<?
if(!$online) {
    ...
    if($id == "Runner92") {
	  ...
	  <img src=\"tools/users/angelique94.jpg\" alt=\"\"><br><strong>
	  ...
	  ";
		...
		echo "<strong>Gr&ouml;sse:</strong> 164 cm<br>
		...
		<strong>Lifestyle:</strong> Raucht nicht<br><br><br><br><br><br><br><br><br>
